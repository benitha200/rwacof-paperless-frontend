      ...
      <Text fontSize="xl" textAlign="center" color="gray.500" mb={6}>Manage All Documents Here</Text>
          ...
          <SimpleGrid alignContent="center" columns={2} spacing={6} h="full">
            <Card bg={cardBg}>
              ...
              <CardFooter>
                <Button leftIcon={<Eye color='white'/>} colorScheme="teal" onClick={() => navigate('/allgrns')}>
                  View GRNs
                </Button>
              </CardFooter>
            </Card>
            <Card bg={cardBg}>
              ...
              <CardFooter>
                <Button leftIcon={<FileText color='white' />} colorScheme="blue" onClick={() => navigate('/financial-reports')}>
                  Generate Reports
                </Button>
              </CardFooter>
            </Card>
